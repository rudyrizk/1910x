...
ACCESS_TOKEN = os.getenv('ACCESS_TOKEN_SP')
ACCESS_TOKEN_SECRET = os.getenv('ACCESS_TOKEN_SECRET_SP')
...
def fetch_content(url):
    ...
    if response.status_code == 200:
        ...
        cleaned_content = re.sub(r'&#039;', "'", cleaned_content)
        cleaned_content = re.split(r'Extraído de la Biblia', cleaned_content)[0]
...
def get_combined_content():
    ...
    url1 = f"https://feed.evangelizo.org/v2/reader.php?lang=SP&type=reading&content=GSP&date={today}"
    url2 = f"https://feed.evangelizo.org/v2/reader.php?date={today}&lang=SP&type=liturgic_t&content=GSP"
    ...
    if content1 and content2:
        ...
        final_content += f"\nContinuar con todas las lecturas https://evangeliodeldia.org/SP/gospel/{formatted_date}" + "\n" +"\n" + '#evangeliodeldia #jesus #evangelio'
        #print(final_content)
